...
contract TreasuryTest is Test {
    ...
    function test_build_public_inputs() public {
        ...
        uint256[] memory public_inputs = relayer.buildPublicInputs(merkleRoot, blockNumber);
    ...
    function test_add_block_with_inputs() public {
        ...
        assertEq(blockNumber, relayer.getBlockNumber(merkleRoot));
        assertEq(merkleRoot, relayer.getMerkleRoot(blockNumber));
    }
