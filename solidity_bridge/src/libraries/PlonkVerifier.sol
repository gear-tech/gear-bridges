...
contract PlonkVerifier {
  ...
  uint256 private constant VK_QL_COM_X = 11655089672400677021286895544876521415279138749563274178049120930916919186220;
  uint256 private constant VK_QL_COM_Y = 19283397661384417831926689756201966361314359587157809323839944556772132025397;
  uint256 private constant VK_QR_COM_X = 20515988983433682151097499095632598119927687581958951744467913857738440275935;
  uint256 private constant VK_QR_COM_Y = 21576662178325048042506122462430830321355573554925793186185554919443050492741;
  uint256 private constant VK_QM_COM_X = 12544100232677836321754250495016863189671667035998181015935139567415326893276;
  uint256 private constant VK_QM_COM_Y = 10322736042436314632355122165949229518703488813488825533790117908479425199295;
  uint256 private constant VK_QO_COM_X = 21589916968922295605694215234586714246069698589611676848501421247694642091500;
  uint256 private constant VK_QO_COM_Y = 16739861004629416033650579509927311688465923227704505950809240874856158428821;
  uint256 private constant VK_QK_COM_X = 16526110582110420734636305264303239498536849386990623802228170164125607299523;
  uint256 private constant VK_QK_COM_Y = 14943408998570579275382715031502017216229470818556675524832029984288584279506;
  
  uint256 private constant VK_S1_COM_X = 17219770138734674010712847810850272405588649017695771615829540889939903466438;
  uint256 private constant VK_S1_COM_Y = 13544288920454744937467837518275466893024986912665520203113704428285751918920;
  
  uint256 private constant VK_S2_COM_X = 18680753096305908958618979078987536993330656546815338831129868713626896761483;
  uint256 private constant VK_S2_COM_Y = 7272426734052534297604723653165995241261982286511177495858188053737264044010;
  
  uint256 private constant VK_S3_COM_X = 4894451713228457980811161650619992937062553340206675967404143358385290090122;
  uint256 private constant VK_S3_COM_Y = 5579190549798609475379486605837070798130428951576898249144355198493338599011;
  
  uint256 private constant VK_COSET_SHIFT = 5;
  
  
  uint256 private constant VK_QCP_0_X = 7084771781927344803361619267748936546273201100530911294390388984048144947791;
  uint256 private constant VK_QCP_0_Y = 10154692200512175004758636629582337722536313943034960708364711106862397655069;
