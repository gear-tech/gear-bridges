...
use ethereum_common::utils::{BeaconBlockHeaderData, BeaconBlockHeaderResponse, MerkleProof};
use ethereum_common::{
    beacon::electra::Block,
    beacon::BlockHeader,
    utils::{self as eth_utils, BeaconBlockResponse},
};
use gclient::ext::sp_runtime::TransactionalError;
...
const BLOCK_4011538: &[u8] = include_bytes!("./blocks/block_4011538.json.zst");
...
async fn test_relayer() {
    ...
    deposit_event_tx.send(TxHashWithSlot {
