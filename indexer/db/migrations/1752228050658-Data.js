module.exports = class Data1752228050658 {
    name = 'Data1752228050658'

    async up(db) {
        await db.query(`CREATE TABLE "transfer" ("id" character varying NOT NULL, "tx_hash" text NOT NULL, "block_number" numeric NOT NULL, "timestamp" TIMESTAMP WITH TIME ZONE NOT NULL, "completed_at" TIMESTAMP WITH TIME ZONE, "completed_at_block" numeric, "completed_at_tx_hash" text, "nonce" text NOT NULL, "source_network" character varying(8) NOT NULL, "source" text NOT NULL, "dest_network" character varying(8) NOT NULL, "destination" text NOT NULL, "status" character varying(15) NOT NULL, "sender" text NOT NULL, "receiver" text NOT NULL, "amount" numeric NOT NULL, "bridging_started_at_block" numeric, "bridging_started_at_message_id" text, CONSTRAINT "PK_fd9ddbdd49a17afcbe014401295" PRIMARY KEY ("id"))`)
        ...
        await db.query(`CREATE TABLE "gear_eth_bridge_message" ("id" character varying NOT NULL, "nonce" text NOT NULL, "block_number" numeric NOT NULL, CONSTRAINT "PK_661c2cb0e1c75454bc0a1239360" PRIMARY KEY ("id"))`)
        await db.query(`CREATE UNIQUE INDEX "IDX_075e0c3cc416dd5e5a4c46a215" ON "gear_eth_bridge_message" ("nonce") `)
        ...
        await db.query(`CREATE TABLE "completed_transfer" ("id" character varying NOT NULL, "nonce" text NOT NULL, "dest_network" character varying(8) NOT NULL, "timestamp" TIMESTAMP WITH TIME ZONE, "tx_hash" text NOT NULL, "block_number" numeric NOT NULL, CONSTRAINT "PK_c966d1eba60d5625faf13b457a4" PRIMARY KEY ("id"))`)
    ...
    async down(db) {
        ...
        await db.query(`DROP TABLE "gear_eth_bridge_message"`)
        await db.query(`DROP INDEX "public"."IDX_075e0c3cc416dd5e5a4c46a215"`)
