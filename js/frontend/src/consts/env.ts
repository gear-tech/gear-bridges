...
const VARA_ARCHIVE_NODE_ADDRESS = import.meta.env.VITE_VARA_ARCHIVE_NODE_ADDRESS as string;
...
export { VARA_NODE_ADDRESS, VARA_ARCHIVE_NODE_ADDRESS, ETH_NODE_ADDRESS, ETH_CHAIN_ID, GTM_ID };
