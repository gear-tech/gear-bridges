...
const ERC20_MANAGER_CONTRACT_ADDRESS = import.meta.env.VITE_ERC20_MANAGER_CONTRACT_ADDRESS as HexString;
...
export { BRIDGING_PAYMENT_CONTRACT_ADDRESS, ETH_BRIDGING_PAYMENT_CONTRACT_ADDRESS, ERC20_MANAGER_CONTRACT_ADDRESS };
