...
contract RelayerTest is TestHelper {
    ...
    function test_build_public_inputs() public pure {
        ...
        assertEq(publicInputs[0], 3980403427572212499963242599334442163722879490045996792884);
        assertEq(publicInputs[1], 1166562204472425303272494454897619262805894610326304849920);
    }
