    ...
    IMessageQueue
{
    ...
    function reinitialize() public onlyRole(DEFAULT_ADMIN_ROLE) reinitializer(4) {
        // MessageQueue contract was updated to https://hoodi.etherscan.io/address/0x37670f62d9ba26431caf8e983912c23b05c25ece#code
        // Verifier contract was updated to https://hoodi.etherscan.io/address/0x2a78eeBb1BAa7e4A9D04ee932Be42Ee90f087027#code
        //
        // https://hoodi.etherscan.io/tx/0x605c94ef14d1ee634b8b22dcfa1e48854978fa80e59a3b4b0fa73aff72262353 - submit merkle root with MessageQueue upgrade
        // https://hoodi.etherscan.io/tx/0xdc4e23d0ee29f1ed0fa1ea05763214ffa21f936b0243a9bd39baf53354bf941b#eventlog - process message with MessageQueue upgrade
        //
        // See event `Upgraded(...)` in logs of the transaction above
        uint256 blockNumber = 22_922_901;
        ...
        // change observers
        _emergencyStopAdmin = address(0x8e3D3370a4769FEcc5c9Bc58EaBeCF7cF1F49edc);

        _emergencyStopObservers.clear();
        _emergencyStopObservers.add(address(0xA6750cc25A606174cbB9e4B3c35aFc69d6F98d31));
    }
