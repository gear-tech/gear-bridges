...
contract PlonkVerifier {
  ...
  uint256 private constant G2_SRS_1_X_0 = 13886407866685460279451500250166689266707012341983329799637560168900196028464;
  uint256 private constant G2_SRS_1_X_1 = 21278184066739899136208841322686599024499904309171138174049932137271723434471;
  uint256 private constant G2_SRS_1_Y_0 = 18065879160672663072689797468664575618862808411645552963166952327573910376630;
  uint256 private constant G2_SRS_1_Y_1 = 20138502953494196653627087433353361861179578337298910723938804425286000337057;
  
  uint256 private constant G1_SRS_X = 1;
  uint256 private constant G1_SRS_Y = 2;

  // ----------------------- vk ---------------------
  uint256 private constant VK_NB_PUBLIC_INPUTS = 6;
  ...
  uint256 private constant VK_QL_COM_X = 11331629422414758544949397958028685941995363586692932750160037556861865767475;
  uint256 private constant VK_QL_COM_Y = 11958426650654718285209004058558962297760183195760109375983335942755069962982;
  uint256 private constant VK_QR_COM_X = 4009630623764973077185063451781010036287254791054102407683375443866614398088;
  uint256 private constant VK_QR_COM_Y = 17512780699501416747953823452514434594904045473066518249413258812905800618285;
  uint256 private constant VK_QM_COM_X = 11526110722836302096586068787302397774933689583641070681992240964614506784240;
  uint256 private constant VK_QM_COM_Y = 8702353549539898017714346227109172848209270990006581888021301992700021201797;
  uint256 private constant VK_QO_COM_X = 14201292371231722180141480307802549336721101644727969487751814987042417374644;
  uint256 private constant VK_QO_COM_Y = 18638596482069943640235148395122376359343771794328342363070530491890459960202;
  uint256 private constant VK_QK_COM_X = 4299538070107396995076640854570223620955736448658123661378002364522520771933;
  uint256 private constant VK_QK_COM_Y = 18570010921622265839090158531498093556466094433087824839559186451890302407980;
  
  uint256 private constant VK_S1_COM_X = 1711097687662156716161467956763592499171252192074419973242535142703206270926;
  uint256 private constant VK_S1_COM_Y = 20517000981854341778087947473254073982330773061690925273437099122216406114620;
  
  uint256 private constant VK_S2_COM_X = 7722058603487571076631841154533155830372360985821363405847313347665805923558;
  uint256 private constant VK_S2_COM_Y = 15701819660590762098056591534778201577444991091921546543214710057838324544777;
  
  uint256 private constant VK_S3_COM_X = 20004504216478601433173486531854610983060944580405703945933291242749847188733;
  uint256 private constant VK_S3_COM_Y = 3200977848666180489800671163976092934038005249868041946208747682135187585412;
  
  uint256 private constant VK_COSET_SHIFT = 5;
  
  
  uint256 private constant VK_QCP_0_X = 9684991981576085790840064720215697753724658694250329808067004471282294771794;
  uint256 private constant VK_QCP_0_Y = 16260608896049557922743402943603606824156834519040080780738165068399883783841;
  
  
  uint256 private constant VK_INDEX_COMMIT_API0 = 8925443;
