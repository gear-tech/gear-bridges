...
use vft_gateway::services::{Config, InitConfig};
...
pub trait VftGateway {
    ...
    create_function!(transfer_vara_to_eth, "TransferVaraToEth", vara_token_id: ActorId, amount: U256, receiver: H160);
}
...
impl VftGateway for Program<'_> {
    ...
    implement_function!(transfer_vara_to_eth, "VftGateway", "TransferVaraToEth", vara_token_id: ActorId, amount: U256, receiver: H160; false);
}
