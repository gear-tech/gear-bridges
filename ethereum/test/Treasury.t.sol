...
import {IMessageQueueProcessor} from "../src/interfaces/IMessageQueueProcessor.sol";
...
contract TreasuryTest is TestHelper {
    ...
    function test_withdraw() public {
        ...
        vm.expectRevert();
        IMessageQueueProcessor(erc20_manager).processMessage(VFT_MANAGER_ADDRESS, call_data);
