    ...
    pub mod runtime_types {
        ...
        pub mod gear_core {
            ...
            pub mod memory {
                ...
                #[decode_as_type(crate_path = "::subxt::ext::scale_decode")]
                // #[encode_as_type(crate_path = "::subxt::ext::scale_encode")]
                pub struct PageBuf(pub [::core::primitive::u64; 2048usize]);
            }
            pub mod message {
                use super::runtime_types;
                pub mod common {
        ...
        pub mod pallet_grandpa_signer {
            ...
            pub mod pallet {
                ...
                pub enum Call {
                    #[codec(index = 0)]
                    #[doc = "Schedule a signing request for the current GRANDPA set."]
                    schedule_request {
                        payload: ::subxt::ext::subxt_core::alloc::vec::Vec<::core::primitive::u8>,
                        set_id: ::core::option::Option<::core::primitive::u64>,
                        expires_at: ::core::option::Option<::core::primitive::u32>,
                    },
                    #[codec(index = 1)]
                    #[doc = "Submit a GRANDPA signature for a scheduled request (unsigned)."]
                    submit_signature {
                        request_id: ::core::primitive::u32,
                        authority: [::core::primitive::u8; 32usize],
                ...
                pub struct SigningRequest {
                    ...
                    pub payload: runtime_types::bounded_collections::bounded_vec::BoundedVec<
                        ::core::primitive::u8,
                    >,
                    pub set_id: ::core::primitive::u64,
                    pub created_at: ::core::primitive::u32,
        ...
        pub mod vara_runtime {
            ...
            pub enum RuntimeCall {
                ...
                #[codec(index = 111)]
                GrandpaSigner(runtime_types::pallet_grandpa_signer::pallet::Call),
            }
            #[derive(
                Debug,
                crate::gp::Decode,
            ...
            pub enum RuntimeError {
                ...
                #[codec(index = 111)]
                GrandpaSigner(runtime_types::pallet_grandpa_signer::pallet::Error),
            }
            #[derive(
                Debug,
                crate::gp::Decode,
            ...
            pub enum RuntimeEvent {
                ...
                #[codec(index = 111)]
                GrandpaSigner(runtime_types::pallet_grandpa_signer::pallet::Event),
            }
            #[derive(
                Debug,
                crate::gp::Decode,
...
pub mod calls {
    ...
    #[doc = "Calls of pallet `GrandpaSigner`."]
    pub enum GrandpaSignerCall {
        ScheduleRequest,
        SubmitSignature,
    }
    impl CallInfo for GrandpaSignerCall {
        const PALLET: &'static str = "GrandpaSigner";
        fn call_name(&self) -> &'static str {
            match self {
                Self::ScheduleRequest => "schedule_request",
                Self::SubmitSignature => "submit_signature",
            }
        }
    }
...
pub mod storage {
    ...
    #[doc = "Storage of pallet `GrandpaSigner`."]
    pub enum GrandpaSignerStorage {
        NextRequestId,
        Requests,
        Signatures,
        SignatureCount,
    }
    impl StorageInfo for GrandpaSignerStorage {
        const PALLET: &'static str = "GrandpaSigner";
        fn storage_name(&self) -> &'static str {
            match self {
...
pub mod exports {
    ...
    pub mod grandpa_signer {
        pub use super::runtime_types::pallet_grandpa_signer::pallet::Event;
    }
}
