...
contract PlonkVerifier {
  ...
  uint256 private constant VK_QL_COM_X = 3415572280152541972358893064864678706428253829100916097712691305123494698274;
  uint256 private constant VK_QL_COM_Y = 21788681468549762769148299605566652907987082448570347541976666158911552682231;
  uint256 private constant VK_QR_COM_X = 18053740299114235931664832729198689572288505708844127469018469931024516239484;
  uint256 private constant VK_QR_COM_Y = 20812671495017257330376936224461724781188241925550220476283687594537048081556;
  uint256 private constant VK_QM_COM_X = 10853370959049801592521093878223219428007932719113892177491276332554373792635;
  uint256 private constant VK_QM_COM_Y = 636733824291654495133903707547248041346934204105632989661446211373257653270;
  uint256 private constant VK_QO_COM_X = 19557307434310124605698654854981395901818416601260145495538695768551613776515;
  uint256 private constant VK_QO_COM_Y = 2551703026972083334552802554151511453702585504028831154935101799191879214800;
  uint256 private constant VK_QK_COM_X = 2541888223109402970128950965403219390417598197589908881821143754067438008720;
  uint256 private constant VK_QK_COM_Y = 11508807028682338145394294811715853971165826680519770235808541816625202723954;
  
  uint256 private constant VK_S1_COM_X = 13423141147048631397278796192358814570635109328906753779854461884893814210870;
  uint256 private constant VK_S1_COM_Y = 17012999667826372675457214995775474249461575302347559748374074074807071640801;
  
  uint256 private constant VK_S2_COM_X = 5356963871387630480698533074715022885883893211775725426115879760551495159633;
  uint256 private constant VK_S2_COM_Y = 16821983293612961180368722074759574552877492007096743683620674828079674766576;
  
  uint256 private constant VK_S3_COM_X = 17810840287140237958523335324800600718963113134886665156535383741848616635682;
  uint256 private constant VK_S3_COM_Y = 15507573030536977030773134069916309681056748207560640991330479941469100825100;
  
  uint256 private constant VK_COSET_SHIFT = 5;
  
  
  uint256 private constant VK_QCP_0_X = 4197223236867481025495406339734650007809964265812657868730002693741329361841;
  uint256 private constant VK_QCP_0_Y = 3510063863230875483398900544214308650178908341362970124656330247420284721670;
  
  
  uint256 private constant VK_INDEX_COMMIT_API0 = 9803656;
